...
from tensorflow.keras.layers import Conv2D,Activation,Input,Add,Subtract,Conv2DTranspose,Concatenate,Multiply
...
# save the model
model.save('./Pretrained_models/MSPABDN_Color.h5')
